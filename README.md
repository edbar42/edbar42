...
<img align="left" alt="GitHub" width="30px" style="padding-right:10px;" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original-wordmark.svg" />
...
Well, during my Physics years I had come across Linux and fell in love with its philosophy and minimalism in contrast to Windows. From there, I got my first programming course in Python and later on did some numerical analysis in order to plot three-dimensional graphs of moving objects when air friction is considered. With that as a baggage, and the high employ-ability of tech jobs, it came to me as a natural choice. Ever since then, I've been dedicating myself to becoming a full-time software developer.  
